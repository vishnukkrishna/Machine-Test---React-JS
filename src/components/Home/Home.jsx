          ...
          <div className="bg-gray-200 md:overflow-hidden">
            <div className="px-4 py-16">
              <div className="relative w-full md:max-w-2xl md:mx-auto text-center">
                <h1 className="font-bold text-gray-700 text-lg sm:text-2xl md:text-3xl leading-tight mb-6">
                  "Transform your business with our weather-focused app. Achieve
                ...
                <div className="hidden md:block h-5 w-5 rounded-full bg-blue-500 absolute top-0 left-0 -ml-36 mt-32" />
              </div>
            </div>
            <svg
