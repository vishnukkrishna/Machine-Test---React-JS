      ...
      <div className="bg-gray-50">
        ...
        <div className="p-4 xl:ml-80">
          ...
          <div className="pt-32 flex flex-wrap justify-center sm:gap-20 md:gap-40 lg:gap-0 gap-0">
            <div className="font-sans flex flex-row w-full sm:w-1/2 lg:w-1/3 justify-center items-center">
            ...
            <div className="font-sans pt-24 sm:pt-10 lg:pt-14 xl:pt-0 flex flex-row w-full sm:w-1/2 lg:w-1/3 justify-center items-center">
              <div className="card w-96 mx-auto bg-white shadow-xl hover:shadow">
                <img
                  className="w-32 mx-auto rounded-full -mt-20 border-8 border-white"
                  src={user}
                ...
                <div className="text-center mt-2 font-light text-sm">@user</div>
                <div className="text-center font-normal text-lg">Location</div>
                <div className="px-6 text-center mt-2 font-light text-sm">
                  <p>Front end Developer</p>
                </div>
                <hr className="mt-8" />
                <div className="flex p-4">
                  <div className="w-1/2 text-center">
                    <span className="font-bold">2.1 k</span> Followers
                  </div>
                  <div className="w-0 border border-gray-300"></div>
                  <div className="w-1/2 text-center">
                    <span className="font-bold">0.9 k</span> Following
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="font-sans pt-24 sm:pt-10 lg:pt-14 xl:pt-0 flex flex-row w-full sm:w-1/2 lg:w-1/3 justify-center items-center">
              <div className="card w-96 mx-auto bg-white shadow-xl hover:shadow">
                ...
                <div className="flex p-4">
                  <div className="w-1/2 text-center">
                    <span className="font-bold">1.5 k</span> Followers
                  </div>
                  <div className="w-0 border border-gray-300"></div>
                  <div className="w-1/2 text-center">
                    <span className="font-bold">1.2 k</span> Following
                  </div>
                </div>
              </div>
            </div>
