    ...
    <>
      <div className="bg-gray-50/50">
        ...
        <div className="p-4 xl:ml-80">
          ...
          <div className="w-full pt-14 sm:pt-32 md:pt-20 lg:pt-40 mx-auto max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 border-b border-gray-900/10 pb-12">
              <div className="p-4 col-span-6 md:col-span-2 lg:col-span-1">
              ...
              <div className="p-4 col-span-6 md:col-span-4 lg:col-span-1">
