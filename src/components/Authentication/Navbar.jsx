    ...
    <>
      <header className="relative w-full h-20 border-b-2 z-[999]">
        <div className="container mx-auto flex items-center justify-between h-full max-w-6xl px-8 sm:px-6 lg:px-8 xl:px-0">
          <Link
            to="/"
            className="relative flex items-center text-2xl h-full font-black transition-transform duration-300 hover:translate-x-2"
          >
            WeatherApp
          ...
          <nav
            ...
            } absolute top-0 left-0  flex flex-col items-center justify-between w-full h-24 pt-5 mt-24 text-sm text-gray-800 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0 md:border-none md:py-0 md:flex md:relative transition-all duration-300`}
          >
            <NavLink
              to="/"
